...
# The line below... make a sequence of years - set up the times that we will iterate through
time_yr <- seq(from = 0, to = 8, by = 1)

# The line below... create an empty matrix with initial population structures across the top and years going down
proj_year <- matrix(ncol = length(fish_year0), nrow = length(time_yr))

# The line below... assign initial population to the first row
proj_year[1, ] <- fish_year0

# The for loop below... for the rest of the rows, use the dot product to calculate the next years population
